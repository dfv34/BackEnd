...
@GetMapping("/lista")
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoedu){      
       ...
       Educacion educacion = new Educacion(dtoedu.getTituloEdu(),dtoedu.getFechainicioEdu(),dtoedu.getFechafinEdu(),dtoedu.getDescEdu(), dtoedu.getImagenEdu());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoedu){
        ...
        if(sEducacion.existsBytituloEdu(dtoedu.getTituloEdu()) && sEducacion.getBytituloEdu(dtoedu.getTituloEdu()).get().getIdEdu() != id)
